...
function SplitContextPanel() {
  ...
  return (
    <div className="state-demo-panel">
      ...
      <h3>Split context (state + dispatch)</h3>
      <p className="state-demo-note">
  ...
  return (
    <section className="effect-demo state-demo">
      ...
      <p className="drill-description">
        Ways to reduce context re-render cost or scale past a single context
        object. See also the Context API and Redux demos.
      </p>
      ...
      <div className="state-demo-panel">
        ...
        <ul className="effect-demo-legend">
          ...
          <li>
            <strong>Split context</strong> — separate state and dispatch (or theme
            vs actions) to limit re-renders.
          </li>
          <li>
